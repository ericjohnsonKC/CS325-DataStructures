 ...
 *  Week 2: Queues
 * 
 *  This assignment is to use the queue container adapter from the STL.
 * 
 ************************************/
...
queue<Patient> waitingQueue;  // This is the queue that will hold patients
...
void nextPatient(){
    ...
    currentPatient = waitingQueue.front();
    waitingQueue.pop();
